...
var BodyColor=null;
themeArray=[
  {head:"linear-gradient(to right,#1ea785,#1ea785)",body:"url('../ImageAssets/Chatbg.png')"},
...
const audio_send=new Audio('../sounds/Send.mp3');
const audio_recieve=new Audio('../sounds/Recieve.mp3');
var flag=true;
