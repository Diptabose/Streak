...
function addOnlineUser(actvuser)
{
 ...
 useronline.setAttribute('id',actvuser);
 useronline.innerText=actvuser;
 onlineBox.append(useronline);
}

function removeOnlineUser(offlineuser)
{
  const useroffline=document.getElementById(offlineuser);
    useronline.remove();
}
